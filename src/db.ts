/**
 * SQLite database access layer for the AEPD (Agencia Española de Protección de Datos) MCP server.
 *
 * Schema:
 *   - decisions    — AEPD resolutions, sanctions, and archive decisions
 *   - guidelines   — AEPD guides, informes, and circulares
