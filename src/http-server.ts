...
const TOOLS = [
  {
    ...
    description:
      "Full-text search across AEPD resoluciones and sanciones. Returns matching decisions with reference, entity name, fine amount, and GDPR articles cited.",
    inputSchema: {
      type: "object" as const,
      properties: {
        query: { type: "string", description: "Search query in Spanish (e.g., 'videovigilancia', 'consentimiento', 'CaixaBank')" },
        type: {
          type: "string",
  ...
  },
  {
    ...
    description: "Get a specific AEPD decision by reference number (e.g., 'PS-00120-2022').",
    inputSchema: {
      type: "object" as const,
      properties: {
        reference: { type: "string", description: "AEPD decision reference" },
      },
      required: ["reference"],
    },
  },
  {
    ...
    description: "Search AEPD guidance documents: guías, informes, and circulares.",
    inputSchema: {
      type: "object" as const,
      properties: {
        query: { type: "string", description: "Search query in Spanish" },
        type: {
          type: "string",
  ...
  },
  {
    ...
    description: "Get a specific AEPD guidance document by its database ID.",
    inputSchema: {
      type: "object" as const,
      properties: {
  ...
  },
  {
    ...
    description: "List all covered data protection topics with Spanish and English names.",
      ...
      switch (name) {
        ...
        case "es_dp_about": {
          return textContent({
            name: SERVER_NAME,
            version: pkgVersion,
            description: "AEPD (Agencia Española de Protección de Datos) MCP server. Provides access to Spanish data protection authority resoluciones, sanciones, and official guidance documents.",
